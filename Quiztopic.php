...
<body>
 ...
 <!-- Video background -->
 <video class="video-bg" src="img/S.E design website mode.mp4" autoplay loop muted playsinline></video>
...
<button id="backButton" class="fancy">
    ...
    <div class="content">
        <div ontouchstart="">
            <div class="button">
                <a href="QuizTrueorFalse.php" class="startButton">True Or False</a>
            </div>
            <div class="button">
                <a href="Quiz1Or0.php" class="startButton">1 or 0</a>
            </div>
            <div class="button">
                <a href="RANDOM_quiz.php" class="startButton">RandomQuestions</a>
            </div>
