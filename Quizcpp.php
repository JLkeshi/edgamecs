...
<video class="video-bg" src="img/S.E design website quiz.mp4" autoplay loop muted playsinline></video>
   ...
   <button id="backButton" class="fancy">
    ...
    <script>
        const questions = [
            { question: "A pointer is declared as 'int *ptr;' in C++.", correct: true },
            { question: "The keyword used for dynamic memory allocation in C++ is 'malloc'.", correct: false },
            { question: "The correct syntax for creating a class in C++ is 'class MyClass {}'.", correct: true },
            { question: "A constructor has a return type like a normal member function.", correct: false },
            { question: "The output of 'cout << (5 > 3) ? 1 : 0;' in C++ is 3.", correct: false },
            { question: "The identifier '1stVar' is valid in C++.", correct: false },
            { question: "'cin.ignore()' ignores all characters in the input buffer.", correct: false },
            { question: "The size of 'int' data type in C++ is 4 bytes.", correct: true },
            { question: "The 'string' data type is used for text strings in C++.", correct: true },
            { question: "The keyword used to indicate the end of a function in C++ is 'return'.", correct: false }
        ];
