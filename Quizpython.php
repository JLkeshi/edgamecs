...
<head>
    ...
    <title>Python Flashcard Quiz</title>
    <style>
    /* Body and Background */
    body {
        margin: 0;
...
<video class="video-bg" src="img/S.E design website quiz.mp4" autoplay loop muted playsinline></video>
    ...
    <script>
        const questions = [
            { question: "In Python, the 'print' function outputs text to the console.", correct: "True" },
            { question: "Python lists can only contain elements of the same data type.", correct: "False" },
            { question: "The 'def' keyword is used to define a function in Python.", correct: "True" },
            { question: "Python is a case-sensitive language.", correct: "True" },
            { question: "Variables must be declared with a type before they are used in Python.", correct: "False" },
            { question: "Python's dictionaries allow duplicate keys.", correct: "False" },
            { question: "Indentation is crucial in Python for defining blocks of code.", correct: "True" },
            { question: "The 'lambda' keyword is used to create anonymous functions in Python.", correct: "True" },
            { question: "Python supports multiple inheritance.", correct: "True" },
            { question: "Python is an interpreted language.", correct: "True" }
        ];
    ...
    const subject = "Python"; // Set this dynamically if needed, based on your page or user selection.
