...
<script>
    const questions = [
        { question: "PHP stands for Personal Hypertext Processor.", correct: "0" },
        { question: "PHP code is embedded within HTML.", correct: "1" },
        { question: "A PHP file can contain text, HTML, CSS, JavaScript, and PHP code.", correct: "1" },
        { question: "PHP is a client-side scripting language.", correct: "0" },
        { question: "PHP scripts are executed on the server.", correct: "1" },
        { question: "PHP is case-sensitive.", correct: "1" },
        { question: "The PHP file extension is '.php'.", correct: "1" },
        { question: "PHP stands for Programming Hypertext Preprocessor.", correct: "0" },
        { question: "PHP can be used to create dynamic web pages.", correct: "1" },
        { question: "You can connect to a database using PHP.", correct: "1" }
    ];
