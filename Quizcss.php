...
<head>
    ...
    <title>CSS Flashcard Quiz</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<video class="video-bg" src="img/S.E design website quiz.mp4" autoplay loop muted playsinline></video>
   ...
   <button id="backButton" class="fancy">
    ...
    <script>
        const questions = [
            { question: "The 'color' property in CSS is used to change the background color of an element.", correct: "False" },
            { question: "CSS stands for Cascading Style Sheets.", correct: "True" },
            { question: "The 'font-size' property is used to control the size of text.", correct: "True" },
            { question: "In CSS, the 'padding' property adds space inside an element, around its content.", correct: "True" },
            { question: "The 'margin' property creates space inside an element.", correct: "False" },
            { question: "CSS can be applied to HTML elements using inline, internal, and external styles.", correct: "True" },
            { question: "The 'border-radius' property in CSS is used to make rounded corners.", correct: "True" },
            { question: "The 'display' property with the value 'none' hides an element from the page but still takes up space.", correct: "False" },
            { question: "The 'position' property can be set to 'static', 'relative', 'absolute', 'fixed', or 'sticky'.", correct: "True" },
            { question: "The 'float' property in CSS is used to center-align an element.", correct: "False" }
        ];
    ...
    const subject = "CSS"; // Set this dynamically if needed, based on your page or user selection.
