...
<body>
 ...
 <!-- Video background -->
 <video class="video-bg" src="img/S.E design website 0 or 1.mp4" autoplay loop muted playsinline></video>
...
<button id="backButton" class="fancy">
    ...
    <div class="content">
        <div ontouchstart="">
            <div class="button">
                <a href="ONE_ZERO-Python.php" class="startButton">Python</a>
            </div>
            <!-- <div class="button">
                <!-- <a href="Quizhtml.php" class="startButton">HTML</a>
            </div> -->
            <div class="button">
                <a href="ONE_ZERO-JS.php" class="startButton">JavaScript</a>
            </div> 
            <div class="button">
                <a href="ONE_ZERO-cpp.php" class="startButton">C++</a>
            </div>
            <div class="button">
                <a href="ONE_ZERO-php.php" class="startButton">Php</a>
            </div>
...
<script>
          // Functionality for back button
          document.getElementById('backButton').addEventListener('click', function() {
    window.location.href = 'Quiztopic.php'; // Redirect to index.html
});
