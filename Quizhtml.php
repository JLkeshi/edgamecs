...
<video class="video-bg" src="img/S.E design website quiz.mp4" autoplay loop muted playsinline></video>
   <!-- Back button -->
    ...
    <script>
        const questions = [
            { question: "HTML stands for Hyper Text Markup Language.", correct: "True" },
            { question: "The <head> element contains the visible content on the page.", correct: "False" },
            { question: "HTML is a programming language.", correct: "False" },
            { question: "CSS is used to style HTML elements.", correct: "True" },
            { question: "The title element specifies the title of the document shown in the browser title bar.", correct: "True" },
            { question: "The br tag is used for a line break.", correct: "True" },
            { question: "The <ol> tag is used for unordered lists.", correct: "False" },
            { question: "HTML files are saved with the .htm or .html extension.", correct: "True" },
            { question: "The <p> tag is used to create paragraphs.", correct: "True" },
            { question: "The <img> tag is used to create a table.", correct: "False" }
        ];
    ...
    const subject = "HTML"; // Set this dynamically if needed, based on your page or user selection.
